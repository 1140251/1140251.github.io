    ...
    <div>
      ...
      <div class="content-selection">
            ...
            <h3 class="mb-0 mt-0 number">
              <em
                ...
                data-target={Math.ceil(
                  (new Date().getTime() - new Date("12/10/2017").getTime()) /
                    (1000 * 3600 * 24)
                )}>0</em
              >
            </h3>
        ...
        <div class="fact-item">
          ...
          <div class="details">
            <h3 class="mb-0 mt-0 number">
              <em class="count" data-target={posts.length}>0</em>
            </h3>
...
{#if showModal}
  <Modal on:close={() => (showModal = false)}>
    <div slot="body" class="body">
      <p>
        To contact me please fill the <a class="no-link" href="/contact"
          >contact form</a
        >
        or send me an
        <a
